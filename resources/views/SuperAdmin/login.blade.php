        ...
        <div class="col-md-6 right-box">
            ...
            <form method="POST" action="{{ route('superadmin.login') }}">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="emailS" class="form-control form-control-lg bg-light fs-6" placeholder="Address Email">
                </div>
                <div class="input-group mb-1">
                    <input type="password" name="mot_de_passeS" class="form-control form-control-lg bg-light fs-6" placeholder="Mot de pass">
                </div>
